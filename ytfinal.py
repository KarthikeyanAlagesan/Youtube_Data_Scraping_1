...
atlas_username = 'karthikeyanalagesan1991'
atlas_password = '9442'
atlas_cluster = 'cluster0'
client = MongoClient(
    f"mongodb+srv://{atlas_username}:{atlas_password}@{atlas_cluster}.b0bwmnh.mongodb.net/?retryWrites=true&w=majority")
# mongodb+srv://karthikeyanalagesan1991:<password>@cluster0.b0bwmnh.mongodb.net/?retryWrites=true&w=majority
db = client['youtube_data']
collection = db['channel_data']
Api_key='AIzaSyBsKFnsDGfcaHGCHo77OuWsU5uCk2FdFvY'
# Set Streamlit app title
st.title("KA_DW_5455_YouTube Data Harvesting and Warehousing_GUVI")

# Display input field for YouTube channel ID
channel_id = st.text_input("Enter Your Favourite YouTube Channel ID")
